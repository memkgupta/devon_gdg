...
const Tracks = () => {
  ...
  return (
    <div className='relative mt-12 tracks-background tracks-bg md:bg-contain bg-cover px-24 py-12'>
...
{/* <div className="absolute inset-0 bg-gradient-to-t from-[#ff0000]/10 to-transparent blur-[2px]"></div> */}
     ...
     <p className='text-center text-7xl font-audiowide text-rose-700 glitch'>Tracks</p>
  ...
  return (
    <TracksCard key={track.name} name={track.name} icon={track.icon} description={track.description}/>
  );
})}
    </div>
    </div>
